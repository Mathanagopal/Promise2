      ...
      <div class="card">
          <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                  <h6 class=' align-self-stretch mx-auto my-auto'>Calories: <br> ${result.recipe.calories.toFixed(2)}</h6>
                  <a href='${result.recipe.url}' target='_blank' class='btn btn-link align-self-stretch'>View Recipe</a>
              </div>
          </div>
      </div>
  </div> 
